...
//Complete Commented Version of Parser 
//Need to implement output such that it matches up with format of Richards 
//TNT 
...
public class SplashParser {
    ...
    public SplashParser() {
	    ...
	    // Need to update this version to include final implement. of input 
	    ...
	    //lineCounter tracks the number of lines that have been parsed for machine penalty 
	    //If it's exactly 8 at the end of processing then throw error 
            int lineCounter = 0;
	    ...
	    //operationGrid 2d array initialization
            operationGrid = new int[SIZEMAX][SIZEMAX];
	    //Task grid is 2D intarray initialization
            taskGrid = new int[SIZEMAX][SIZEMAX];
	    //fpaPenalty is total value of fpa accumulated over processing the forced partial assignment 
	    //Initilizing counter for total forced penalty assignment 
            fpaPenalty = 0;
    ...
    // Returning one with new structure
    ...
    private void parseError(String erCode) {
        ...
        { //Potentially should be error while parsing input file
